...
<script>
import Grid from '../docs/Grid.vue';
import WebRTC from '../docs/WebRTC.vue';
...
export default {
  ...
  computed: {
    compo(){
      ...
      console.log(upName);
      // import('../../dist/Grid.js').then( page => {
      //   console.log(page)
      // })
      // import(`./${upName}.js`).then((page) => {
      //   var com = page.bundle
      //   for(let k in page) {
      //     console.log(k)
      //   }
...
.guide-page{
  ...
  .doc-area{
    ...
    button:hover {
      background-color: rgb(78, 162, 247);
    }
  }
